      ...
      <Box maxW="lg" px={8} py={12} borderWidth={1} borderRadius={8} boxShadow="lg">
        ...
        <Stack spacing={4}>
          ...
          <Box>
            ...
            <input type="text"  maxLength={12} placeholder="0000 0000 0000 0000" value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} />
          </Box>
          <Flex justify="space-between">
            <Box mr={4} flex={1}>
              <Text mb={2}>Expiration Date</Text>
              <input type="text" maxLength={4} placeholder="MM/YY" value={expirationDate} onChange={(e) => setExpirationDate(e.target.value)}/>
